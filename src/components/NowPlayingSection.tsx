    ...
    <section className="grid grid-cols-1 md:grid-cols-12 gap-0 border-b border-outline-variant/10">
      <div className="md:col-span-8 p-8 flex flex-col justify-center">
        <div className="flex items-center gap-4 mb-4">
          ...
          <h3 className={`font-headline text-2xl font-bold uppercase tracking-widest ${statusColor}`}>{statusText}</h3>
        </div>
        <h2 className="text-5xl font-black font-headline mb-6 uppercase tracking-tighter">
          {currentTrack ? `EP ${currentTrack.number}: ${currentTrack.title}` : "NO SESSION LOADED"}
        </h2>
        <div className="w-full h-1 bg-surface-container-highest mb-8 relative overflow-hidden">
          <div 
      ...
      <div className="md:col-span-4 bg-surface-container-low p-8 flex flex-col justify-between border-l border-outline-variant/10">
        <p className="font-label text-[10px] tracking-widest text-on-surface-variant uppercase mb-4">Master Bus Levels</p>
        <div className="flex flex-col gap-2">
          {/* VU Meter L */}
          <div className="flex items-center gap-2">
            <span className="font-label text-[8px] text-on-surface-variant w-4">L</span>
            <div className="flex-1 h-6 bg-surface-container-lowest flex gap-0.5 p-0.5">
          ...
          {/* VU Meter R */}
          <div className="flex items-center gap-2">
            <span className="font-label text-[8px] text-on-surface-variant w-4">R</span>
            <div className="flex-1 h-6 bg-surface-container-lowest flex gap-0.5 p-0.5">
